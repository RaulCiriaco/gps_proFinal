...
import polyline  # <- necesario para decodificar la ruta
...
def calcular_ruta():
    ...
    body = {
        "coordinates": coords,
        "instructions": True
        # NOTA: no se incluye geometry_format para dejarlo como "encodedpolyline"
    }
    ...
    try:
        ...
        distancia_manhattan = round(
            abs(origen_coord[0] - destino_coord[0]) * 111 +
            abs(origen_coord[1] - destino_coord[1]) * 85, 2
        )
